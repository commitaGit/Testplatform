...
//            logger.error("okhttp3 post error >> ex = {}", ExceptionUtils.getStackTrace(e));
    ...
    public static String getForHeader(String url, Map<String, String> queries,Map<String,String> headers) {
        ...
        while (iterator2.hasNext()) {
            Map.Entry headermap = (Map.Entry<String, String>) iterator2.next();
            request.addHeader((String)headermap.getKey(),(String)headermap.getValue());
        }
        request.url(sb.toString());
        request.build();
//                .addHeader((String) headermap.getKey(), (String) headermap.getValue())
//                .url(sb.toString())
//                .build();
        Response response = null;
        try {
...
//        String response = getForHeader("https://backend-test.seecsee.com/api/ng/cpc/cpcSettingList?page=1&pageSize=30&type=2&backendId=667", null);
